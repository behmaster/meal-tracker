function Home() {
    return(
        <main>
            ...
            <img height="300" width="500" src="http://localhost:4000/images/plate1.png" alt="plate1" /> */}
            <img width="100%" src="http://localhost:4000/images/plate5.avif" alt="plate of food" /> 
